...
fournisseur::fournisseur(int id,QString adresse,QString nom,QString email,int tel,QString sexe ,int age)
{
  this->id=id;
...
void fournisseur::set_tel(int t){  tel=t;}
...
query.prepare("INSERT INTO fournisseur (ID_FOURNISSEUR, ADRESSE_FOURNISSEUR,NOM_FOURNISSEUR,EMAIL_FOURNISSEUR,TEL_FOURNISSEUR,SEXE_FOURNISSEUR,AGE_FOURNISSEUR) "
                    "VALUES (:id, :adresse, :nom, :email, :tel, :sexe, :age)");
...
QString res2= QString::number(tel);
QString res3= QString::number(age);
query.prepare("update  fournisseur set ID_FOURNISSEUR=:id , ADRESSE_FOURNISSEUR=:adresse,NOM_FOURNISSEUR=:nom,EMAIL_FOURNISSEUR=:email,TEL_FOURNISSEUR=:tel,SEXE_FOURNISSEUR=:sexe,AGE_FOURNISSEUR=:age "
