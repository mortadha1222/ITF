...
equipement::equipement(int quantite,int reference,QString nom,QString datedachat,int idf)
{
...
int equipement::get_reference(){return reference;}
...
bool equipement::supprimer(int referencee)
{
QSqlQuery query;
QString res= QString::number(referencee);
