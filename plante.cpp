...
plante::plante(QString nomm,int nb,float prixx,float surfacee,float humiditee,QString fructificationn,float fprixx,int agee,QString reclotee,int typee,int zonee)
{
...
QString plante::get_fructification(){return fructification ;}
...
query.prepare("INSERT INTO PLANTE (NOM_PLANTE,NOMBRE,PRIX,SURFACE,HUMIDITE,FRUCTIFICATION,FPRIX,AGE,RECLOTE,TYPE,ZONE) "
                    "VALUES (:nom_plante,:nombre,:prix,:surface,:humidite,:fructification,:fprix,:age,:reclote,:type,:zone)");
...
query.bindValue(":fructification",fructification);
